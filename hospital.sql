...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2018 at 05:33 AM
...
--
-- Stand-in structure for view `patient_admin_details`
-- (See below for the actual view)
--
CREATE TABLE `patient_admin_details` (
...
--
-- Stand-in structure for view `patient_doctor`
-- (See below for the actual view)
--
CREATE TABLE `patient_doctor` (
`patientFirstName` varchar(12)
,`patientSurname` varchar(20)
,`doctorFirstName` varchar(16)
...
--
-- Stand-in structure for view `patient_med_details`
-- (See below for the actual view)
--
CREATE TABLE `patient_med_details` (
`First_Name` varchar(12)
,`Surname` varchar(20)
...
ALTER TABLE `operation`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `Room` (`Room`),
  ADD KEY `Patient_Case` (`Patient_Case`);
...
ALTER TABLE `performs`
  ADD PRIMARY KEY (`Operation`,`Staff`),
  ADD KEY `Staff` (`Staff`);
...
--
ALTER TABLE `bed`
  ADD CONSTRAINT `bed_ibfk_1` FOREIGN KEY (`Location`) REFERENCES `department` (`DeptNo`);

--
-- Constraints for table `department`
--
ALTER TABLE `department`
  ADD CONSTRAINT `department_ibfk_1` FOREIGN KEY (`Dept_Head`) REFERENCES `staff` (`PPSN`);

--
-- Constraints for table `operation`
--
ALTER TABLE `operation`
  ADD CONSTRAINT `operation_ibfk_1` FOREIGN KEY (`Room`) REFERENCES `room` (`Number`),
  ADD CONSTRAINT `operation_ibfk_2` FOREIGN KEY (`Patient_Case`) REFERENCES `stay` (`ID`);

--
-- Constraints for table `performs`
--
ALTER TABLE `performs`
  ADD CONSTRAINT `performs_ibfk_1` FOREIGN KEY (`Operation`) REFERENCES `operation` (`ID`),
  ADD CONSTRAINT `performs_ibfk_2` FOREIGN KEY (`Staff`) REFERENCES `staff` (`PPSN`);

--
-- Constraints for table `room`
--
ALTER TABLE `room`
  ADD CONSTRAINT `room_ibfk_1` FOREIGN KEY (`Location`) REFERENCES `department` (`DeptNo`);

--
-- Constraints for table `staff`
--
ALTER TABLE `staff`
  ADD CONSTRAINT `staff_ibfk_1` FOREIGN KEY (`Supervisor`) REFERENCES `staff` (`PPSN`),
  ADD CONSTRAINT `staff_ibfk_2` FOREIGN KEY (`Dept`) REFERENCES `department` (`DeptNo`);

--
-- Constraints for table `stay`
--
ALTER TABLE `stay`
  ADD CONSTRAINT `stay_ibfk_1` FOREIGN KEY (`Patient`) REFERENCES `patient` (`PPSN`),
  ADD CONSTRAINT `stay_ibfk_2` FOREIGN KEY (`Doctor`) REFERENCES `staff` (`PPSN`),
  ADD CONSTRAINT `stay_ibfk_3` FOREIGN KEY (`Bed_No`) REFERENCES `bed` (`Number`);
COMMIT;
